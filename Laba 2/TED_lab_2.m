...
x1= input('Введите кол-во приборов (от 4 до 10), x1=');%Ввід даних
for i=1:5 % проверка условия выбора X1, дается пять шансов ввести данные верно
if x1<4 || x1>10 
    x1= input('Введите кол-во приборов (не более 10 !!! и не мение 4 !!!), x1='); 
else
...
if  x2>x1 && x2<1
x2= input('Введьонок кол-во наладчиков не оптимально. Введите не более чем кол-в приборов и не равное 0, x2=');
else if x2<=x1
    break
        end
end
...
tn=input('среднее время на отказ (часов), tn=');%оператор вводит.... среднее время на отказ (часов)
tv=input('реднее время возобновления работоспособности (часов), tv=');%оператор вводит.... среднее время возобновления работоспособности (часов)
